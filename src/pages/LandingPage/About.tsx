...
const About = () => {
  return (
    ...
    >
      ...
      >
        <Typography.Title level={1} style={{ color: "#fff", fontSize: "48px" }}>
          About Us
        </Typography.Title>
        <Typography.Paragraph style={{ color: "#ddd", fontSize: "18px" }}>
          We are dedicated to providing the best room booking services, ensuring
          a seamless and secure experience for our users. Our platform offers a
          wide range of features that cater to different customer needs, making
        ...
        <Row gutter={[16, 16]} justify="center">
          <Col xs={24} sm={12} md={8}>
            ...
            >
              ...
              <Typography.Paragraph style={{ color: "#ddd" }}>
                Book your rooms quickly and easily with our intuitive platform.
              </Typography.Paragraph>
            </Card>
          </Col>
          <Col xs={24} sm={12} md={8}>
          ...
          <Col xs={24} sm={12} md={8}>
            ...
            >
              ...
              <Typography.Paragraph style={{ color: "#ddd" }}>
                Your payments are protected with our top-notch security systems.
              </Typography.Paragraph>
            </Card>
          </Col>
        </Row>
